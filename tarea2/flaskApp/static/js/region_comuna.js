...
// Código para elegir la comuna
console.log("HOLAAAA")
let regionSelect = document.getElementById("region");

region_comuna.regiones.forEach(region => {
    console.log("FUNCIONA ESTO ONO")
...
regionSelect.addEventListener("change", () => {
    const seleccion = parseInt(regionSelect.value); 
    comunaSelect.innerHTML = '<option value="">Seleccione una comuna</option>';

    const regionEncontrada = region_comuna.regiones.find(r => r.numero === seleccion);
